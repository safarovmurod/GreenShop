...
const OrderModal = ({ open = true, onClose }) => {
  if (!open) return null;

  // Маҳсулоти фармоишӣ барои мисол
  const orderedItems = [
    { ...plants[0], quantity: 2 },
    { ...plants[4], quantity: 6 },
    { ...plants[5], quantity: 9 },
      ...
      >
        ...
        >
          ...
          <Box sx={{ borderRight: "1px solid #eaeaea", px: 1 }}>
            ...
            <Typography sx={{ fontWeight: "bold", fontSize: "14px", color: "#3D3D3D" }}>15 Sep, 2021</Typography>
          </Box>
          <Box sx={{ borderRight: "1px solid #eaeaea", px: 1 }}>
            <Typography sx={{ fontSize: "12px", color: "#727272" }}>Total</Typography>
            <Typography sx={{ fontWeight: "bold", fontSize: "14px", color: "#3D3D3D" }}>$2,699.00</Typography>
          </Box>
          <Box sx={{ pl: 1 }}>
            <Typography sx={{ fontSize: "12px", color: "#727272" }}>Payment Method</Typography>
            <Typography sx={{ fontWeight: "bold", fontSize: "13px", color: "#3D3D3D" }}>Cash on delivery</Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", py: 2, fontSize: "14px", color: "#3D3D3D" }}>
            ...
            <Typography sx={{ fontWeight: "bold" }}>$16.00</Typography>
          </Box>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", py: 2, fontSize: "16px", fontWeight: "bold", color: "#3D3D3D", borderTop: "1px solid #eaeaea", borderBottom: "1px solid #eaeaea", mb: 3 }}>
            ...
            <Typography sx={{ color: "#46A358", fontSize: "18px" }}>$2,699.00</Typography>
          </Box>
