...
export default function FeaturedArticle() {
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", mt: { xs: 5, md: 8 }, px: { xs: 2, md: 0 }, display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, backgroundColor: "#f2f9f3" }}>
      <Box data-aos="fade-right" component="img" src={image} alt="Plant in a bright home" sx={{ width: "100%", height: { xs: 260, md: 360 }, objectFit: "contain" }} />
      <Box data-aos="fade-left" sx={{ p: { xs: 3, md: 6 }, alignSelf: "center" }}>
