...
export default function BlogNewsletter() {
  return (
    <Box data-aos="fade-up" sx={{ maxWidth: 1200, mx: "auto", mb: { xs: 6, md: 10 }, px: { xs: 2, md: 0 }, display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: { md: "center" }, justifyContent: "space-between", gap: 3, borderTop: "1px solid #e5e9e5", pt: 4 }}>
      <Box>
