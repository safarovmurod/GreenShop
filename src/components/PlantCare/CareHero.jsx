  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", px: { xs: 2, md: 0 }, py: { xs: 5, md: 8 }, display: "grid", gridTemplateColumns: { xs: "1fr", md: "1.1fr .9fr" }, alignItems: "center", backgroundColor: "#f2f9f3" }}>
      <Box sx={{ p: { xs: 2, md: 5 } }}>
        ...
        <Typography component="h1" data-aos="fade-up" sx={{ mt: 1.5, color: "#3d3d3d", fontSize: { xs: 42, md: 62 }, lineHeight: 1.05, fontWeight: 700 }}>Help your plants thrive</Typography>
